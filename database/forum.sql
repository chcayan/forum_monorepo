...
-- ----------------------------
-- Table structure for error_track
-- ----------------------------
DROP TABLE IF EXISTS `error_track`;
...
) ENGINE = InnoDB AUTO_INCREMENT = 60 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '用户行为及处罚日志表' ROW_FORMAT = Dynamic;
